    ...
    <div class="container">
      ...
      <div class="widget widget-table action-table" >
            <div class="widget-header"> <i class="icon-th-list"></i>
              <h3>All Feedback Records</h3><a style="float:right; margin-right:5px; margin-top:5px;" href="#" class="export"><input type="button" value="Export data in CSV"></a><select style="float:right; margin-right:5px; margin-top:8px;"><option>View 7 days data</option><option>View 15 days data</option><option>View 1 month data</option></select>
            </div>
